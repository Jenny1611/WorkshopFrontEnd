  ...
  return (
    <>
      <div className={styles.container}>
        <h1>Relazione sul Codice Creato by Chat GPT</h1>
        <p>
        ...
        <ul>
          <li>
            ...
            <ul>
              <li>
                <em>Pagina "Chi siamo":</em> Descrive l'istituto ITS Alto Adriatico, evidenziando la mission e il ruolo
      ...
      <ul className={styles.ul} id="header">
        ...
        <li className={styles.li}>
          <a className={styles.a} onClick={() => setCurrentPage("home")}>Home</a>
        </li>
        <li className={styles.li}>
          <a className={styles.a} onClick={() => setCurrentPage("form")}>Chi siamo</a>
        </li>
